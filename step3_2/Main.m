...
% 
%    2.6046e+04
P_e_12=P_e_12.* (0.9 + 0.2 * rand(1,24));
P_e_13=P_e_13.* (0.9 + 0.2 * rand(1,24));
P_e_23=P_e_23.* (0.9 + 0.2 * rand(1,24));
P_e_21=P_e_21.* (0.9 + 0.2 * rand(1,24));
P_e_31=P_e_31.* (0.9 + 0.2 * rand(1,24));
P_e_32=P_e_32.* (0.9 + 0.2 * rand(1,24));
% lambda_e_12=zeros(1,24);%MG1和MG2之间的拉格朗日乘子
% lambda_e_13=zeros(1,24);%MG1和MG3之间的拉格朗日乘子
% lambda_e_21=zeros(1,24);%MG2和MG1之间的拉格朗日乘子
% lambda_e_23=zeros(1,24);%MG2和MG3之间的拉格朗日乘子
...
iter=1;%迭代次数初始化
%对微网之间的交易量记录矩阵初始化
pri_e_12=zeros(maxIter+1,24)+pri_e_12(19,:);pri_e_21=zeros(maxIter+1,24)+pri_e_21(19,:);
pri_e_13=zeros(maxIter+1,24)+pri_e_13(19,:);pri_e_31=zeros(maxIter+1,24)+pri_e_31(19,:);
pri_e_23=zeros(maxIter+1,24)+pri_e_23(19,:);pri_e_32=zeros(maxIter+1,24)+pri_e_32(19,:);
kesai_12 = zeros(maxIter+1,24)+kesai_12(19,:);
kesai_13 = zeros(maxIter+1,24)+kesai_13(19,:);
kesai_21 = zeros(maxIter+1,24)+kesai_21(19,:);
kesai_23 = zeros(maxIter+1,24)+kesai_23(19,:);
kesai_31 = zeros(maxIter+1,24)+kesai_31(19,:);
kesai_32 = zeros(maxIter+1,24)+kesai_32(19,:);
r_list2 = [];
%% 迭代
while 1
    if iter==maxIter  %限制迭代次数
